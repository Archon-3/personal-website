...
function initInteractiveCursor() {
    ...
    cursorGlow.style.cssText = `
        ...
        width: 40px;
        height: 40px;
        background: radial-gradient(circle, rgba(197, 205, 209, 0.4), transparent 70%);
        border-radius: 50%;
        pointer-events: none;
        z-index: 9998;
    ...
    interactiveElements.forEach(el => {
        el.addEventListener('mouseenter', () => {
            ...
            cursor.style.backgroundColor = 'rgba(197, 205, 209, 0.2)';
...
function initScrollProgress() {
    ...
    progressBar.style.cssText = `
        ...
        box-shadow: 0 2px 10px rgba(197, 205, 209, 0.5);
    `;
...
function initFloatingShapes() {
    ...
    const shapes = [
        { size: 100, duration: 20, color: 'rgba(197, 205, 209, 0.1)' },
        { size: 150, duration: 25, color: 'rgba(157, 168, 174, 0.08)' },
        { size: 80, duration: 18, color: 'rgba(120, 133, 140, 0.1)' },
        { size: 120, duration: 22, color: 'rgba(197, 205, 209, 0.06)' },
        { size: 90, duration: 19, color: 'rgba(157, 168, 174, 0.08)' }
    ];
            ...
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="gradient${sectionIndex}" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" style="stop-color:#c5cdd1;stop-opacity:0.5" />
                        <stop offset="100%" style="stop-color:#78858c;stop-opacity:0.5" />
                    </linearGradient>
                </defs>
